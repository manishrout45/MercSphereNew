...
>
  ...
  <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
    ...
    <p className="max-w-3xl mx-auto text-lg text-blue-100">
      Merc Sphere helps businesses improve search engine rankings, drive
      organic traffic, and increase online visibility with result-driven
      SEO strategies.
    </p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <p className="text-gray-600 text-lg leading-relaxed mb-10">
        We help businesses improve their search engine rankings, increase
        organic traffic, and generate quality leads through strategic,
        data-driven SEO solutions tailored to your goals.
      </p>
    ...
    <div className="relative flex justify-center">
      <img
        src="https://img.freepik.com/free-vector/seo-analysis-concept-illustration_114360-9862.jpg?w=740&t=st=1696118000~exp=1696118600~hmac=placeholder"
        alt="SEO Services"
...
<section className="py-20 bg-white text-blue-700">
  <div className="max-w-7xl mx-auto px-4 text-center">
    ...
    <p className="text-gray-500 mb-8 max-w-2xl mx-auto">
      Let Merc Sphere boost your search engine rankings, drive organic traffic,
      and grow your business with result-oriented SEO strategies.
    </p>
