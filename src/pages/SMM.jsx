...
>
  ...
  <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
    ...
    <p className="max-w-3xl mx-auto text-lg text-blue-100">
      Merc Sphere helps brands grow their online presence through strategic
      social media management, engaging content creation, and performance-driven
      campaigns.
    </p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <p className="text-gray-600 text-lg leading-relaxed mb-10">
        We help brands grow, engage, and convert through strategic social media
        management. From content creation and audience targeting to paid
        campaigns and analytics, we ensure your business stands out and builds
        meaningful connections across all major platforms.
      </p>

      {/* SUB HEADING */}
      <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-8">
        Choose Us for Powerful Social Media Growth & Engagement
      </h2>
      ...
      <div className="grid sm:grid-cols-2 gap-y-6 gap-x-10 mb-12">
        {[
          ...
          "24×7 Campaign Monitoring & Support",
        ].map((item, index) => (
    ...
    <div className="relative flex justify-center">
      <img
        src="https://img.freepik.com/free-vector/web-design-work-process_1284-34411.jpg?ga=GA1.1.1312737827.1743758138&semt=ais_user_personalization&w=740&q=80"
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      <ServiceCard
        ...
        desc="Data-driven social media strategies tailored to your brand, audience, and business goals."
        bgImage="https://images.unsplash.com/photo-1522199710521-72d69614c702"
      />
      <ServiceCard
        icon={<FiCode />}
        title="Content Creation & Management"
        desc="Creative posts, reels, stories, and captions designed to boost engagement and brand visibility."
        bgImage="https://images.unsplash.com/photo-1518770660439-4636190af475"
      />
      <ServiceCard
        icon={<FiSmartphone />}
        title="Multi-Platform Management"
        desc="Professional management across Instagram, Facebook, LinkedIn, Twitter, and more."
        bgImage="https://images.unsplash.com/photo-1517433456452-f9633a875f6f"
      />
      <ServiceCard
        icon={<FiZap />}
        title="Paid Ads & Campaign Management"
        desc="High-converting paid campaigns to increase reach, generate leads, and drive sales."
        bgImage="https://images.unsplash.com/photo-1498050108023-c5249f4df085"
      />
      <ServiceCard
        icon={<FiShield />}
        title="Community Management"
        desc="Active audience engagement, comment moderation, and reputation management."
        bgImage="https://images.unsplash.com/photo-1563013544-824ae1b704d3"
      />
      <ServiceCard
        icon={<FiTrendingUp />}
        title="Analytics & Performance Reporting"
        desc="Detailed performance tracking and monthly reports to optimize growth and ROI."
  ...
  <div className="max-w-7xl mx-auto px-4 relative z-10">
    ...
    <div className="relative">
      ...
      <div className="grid md:grid-cols-4 gap-12 relative z-10">
        <WaveStep number="01" icon={<FiSearch />} title="Research & Strategy Planning" delay="0s" />
        <WaveStep number="02" icon={<FiPenTool />} title="Content Creation & Scheduling" delay="0.2s" />
        <WaveStep number="03" icon={<FiSettings />} title="Campaign Execution & Optimization" delay="0.4s" />
        <WaveStep number="04" icon={<FiSend />} title="Reporting & Growth Scaling" delay="0.6s" />
      </div>
    </div>
  </div>
</section>
...
<section className="py-20 bg-white text-blue-700">
  <div className="max-w-7xl mx-auto px-4 text-center">
    ...
    <p className="text-gray-500 mb-8 max-w-2xl mx-auto">
      Let Merc Sphere manage your social media with strategic content,
      targeted campaigns, and data-driven growth strategies that increase
