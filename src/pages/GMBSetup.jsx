...
import GMBPricing from "../components/GMBPricing";

export default function GMBSetup() {
  return (
...
>
  ...
  <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
    <h1 className="text-4xl md:text-5xl font-bold mb-6">
      Google My Business (GMB) Setup Services
    </h1>
    <p className="max-w-3xl mx-auto text-lg text-blue-100">
      Merc Sphere helps businesses create and optimize their Google My Business
      profiles to improve local visibility, attract more customers, and grow
      faster in Google Search and Maps.
    </p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
    ...
    <div>
      <h1 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-6">
        Professional Google My Business Setup Services
      </h1>

      <p className="text-gray-600 text-lg leading-relaxed mb-10">
        We help businesses create, verify, and optimize their Google My Business
        profiles to improve local search visibility, build trust, and attract
        more customers from Google Search and Maps.
      </p>

      {/* SUB HEADING */}
      <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-8">
        Why Choose Us for Your GMB Setup?
      </h2>
      ...
      <div className="grid sm:grid-cols-2 gap-y-6 gap-x-10 mb-12">
        {[
          ...
          "Ongoing Support & Profile Management",
        ].map((item, index) => (
    ...
    <div className="relative flex justify-center">
      <img
        ...
        alt="Google My Business Setup Services"
...
<section className="py-20 bg-white text-blue-700">
  <div className="max-w-7xl mx-auto px-4 text-center">
    <h2 className="text-3xl md:text-4xl font-bold mb-4">
      Ready to Boost Your Google Business Profile?
    </h2>
    <p className="text-gray-500 mb-8 max-w-2xl mx-auto">
      Let Merc Sphere optimize and manage your Google Business Profile to increase visibility, attract more customers, and grow your business online.
    </p>
